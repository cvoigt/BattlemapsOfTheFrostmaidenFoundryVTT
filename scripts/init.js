(() => {
  const adventureName = 'Battlemaps Of The Frostmaiden';
  const moduleName = 'battlemaps-of-the-frostmaiden';
   ...
   */
  const welcomeJournal = 'Welcome to Battlemaps Of The Frostmaiden';
  /**
   ...
   */
  const additionalModulePacks = ["battlemaps-of-the-frostmaiden"];
